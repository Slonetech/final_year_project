...
import { useAgedReceivables, useExportToPDF, usePrintReport } from "@/hooks/use-reports";
...
export default function AgedReceivablesPage() {
  const { data: receivables, isLoading, error } = useAgedReceivables();
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          <p className="text-destructive mb-2">Failed to load aged receivables</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between print:hidden">
        <div>
          ...
          <p className="text-muted-foreground">Track outstanding customer balances by age</p>
        </div>
        <div className="flex gap-2">
          ...
          <Button onClick={() => exportToPDF("Aged Receivables")}>
      ...
      <Card>
        ...
        <div className="hidden print:block px-6 pt-6 pb-4 border-b">
          <div className="text-center">
            <h2 className="text-2xl font-bold">Aged Receivables Report</h2>
          ...
          {isLoading ? (
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">Loading aged receivables...</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center">
              <p className="text-muted-foreground mb-2">No receivables data available</p>
              <p className="text-sm text-muted-foreground">
                Outstanding customer balances will appear here
              </p>
            </div>
          )}
        </CardContent>
      ...
      <Card className="print:hidden">
        <CardHeader>
          <CardTitle className="text-base">Understanding Aged Receivables</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>
              The aged receivables report shows the outstanding balances owed by customers, categorized by how long the invoices have been unpaid.
            </p>
          ...
          <div className="pt-2 border-t">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2 text-sm text-muted-foreground">
              <li>Review this report weekly to stay on top of collections</li>
              <li>Send payment reminders for invoices over 15 days</li>
              <li>Contact customers personally for balances over 60 days</li>
              <li>Consider offering payment plans for large overdue amounts</li>
            </ul>
          </div>
        </CardContent>
      </Card>
