...
import { useSalesOrders, useDeleteSalesOrder } from "@/hooks/use-sales";
...
export default function SalesPage() {
    ...
    const { data: orders, isLoading, error } = useSalesOrders(filters);
        ...
        return (
            <div className="flex items-center justify-center h-96">
                <div className="text-center">
                    <p className="text-destructive mb-2">Failed to load sales orders</p>
